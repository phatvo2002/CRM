...
const ModalEditKhachHangTiemNang = (props) => {
  const {
      showModal,
      closeModal,
      typeModal,
    ...
    { id } = useParams(),
    header = "Chỉnh sửa thông tin thành khách hàng",
    {
      data: dataHangHoaQuanTam,
      isFetching: { ishangHoaQuanTamFetching },
    } = useGetHangHoaQuanTamByKhachHangTiemNangIdQuery(selectedItem?.id, {
      skip: selectedItem?.id == null,
    }),
    {
      ...
      modalRef.current?.reset(
        {
          ...
          [modelObj.maNguonGocKhachHang]:
            selectedItem[modelObj.maNguonGocKhachHang],
          [modelObj.maPhongbanKhachHang]:
            selectedItem[modelObj.maPhongbanKhachHang],
          [modelObj.maLoaiTiemNang]: selectedItem[modelObj.maLoaiTiemNang],
          [modelObj.maLoaiHinhNgheNghiep]:
            selectedItem[modelObj.maLoaiHinhNgheNghiep],
...
export default ModalEditKhachHangTiemNang;
