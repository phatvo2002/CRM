...
export const apiHangHoaQuanTam = createApi({
    ...
    endpoints: (builder) => ({
      ...
      getHangHoaQuanTamByKhachHangId: builder.query({
        query: (id) => `/HangHoaQuanTam/gethanghoaquantambykhachhangid/${id}`,
      }),
      ...
      getHangHoaQuanTamByDonHangId: builder.query({
        query: (id) => `/HangHoaQuanTam/gethanghoaquantambydonhangid/${id}`,
      }),
  ...
  export const { 
   ...
   useGetHangHoaQuanTamByDonHangIdQuery,
  } = apiHangHoaQuanTam;
