...
{
    public class KhachHangTiemNangServices : BaseServices<KhachHangTiemNang , KhachHangTiemNangModel , Guid , KhachHangTiemNangDTO> , IKhachHangTiemNangServices
    {
        private readonly IKhachHangTiemNangRepository _khachHangTiemNang;
        public KhachHangTiemNangServices(IKhachHangTiemNangRepository khachHangTiemNang) : base(khachHangTiemNang)
        {
